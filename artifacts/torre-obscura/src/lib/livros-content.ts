...
const VOLUME_1: CapituloLivro[] = [
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'E no décimo nono, o silêncio. Não a ausência de som, mas a entidade respirando devagar para não assustar a presa antes da hora. O Susurro do Limiar é essa respiração — e, ao deixar que você a ouvisse, ele avisou.',
...
const VOLUME_2: CapituloLivro[] = [
  {
    ...
    paragrafos: [
      ...
      'O vestígio do vigésimo primeiro andar vive na lembrança de um instante que ainda não aconteceu. Ele reconheceu você porque já viu a sua chegada — numa memória vinda de um futuro que pode ou não se tornar real. O rastro lido ali não era do passado. Era uma possibilidade.',
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'Um habitante existe apenas nesta janela: enquanto o Intervalo está aberto e ainda não foi de todo percorrido. Não é ser da Torre; é ser do meio-tempo entre o que ela foi e o que ainda não é. Quando a janela fechar, ele simplesmente não estará mais aqui.',
