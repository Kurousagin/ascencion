...
const VOLUME_1: CapituloLivro[] = [
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'E o vigia do penúltimo ciclo guarda o que aguarda no alto: uma pergunta que o Fundador formulou antes de morrer — não de velhice, mas de escolha deliberada. Ele entrou no vigésimo andar sabendo que não sairia, porque a pergunta que deixou lá só pode ser respondida por quem ainda não fez a escolha que ele fez. A resposta errada não mata. A certa transforma — e ele nunca disse em quê.',
    ],
  },
  {
    capitulo: 4,
    ...
    paragrafos: [
      ...
      'E então, o topo. Não havia entidade alguma esperando ser encontrada. Ela emergiu da convergência dos dezanove: dezasseis fragmentos de algo que nunca deveria ter sido dividido, e três Âncoras que o Fundador plantou nos marcos da subida para conter a reunificação. Os Construtores separaram o que era um. O Fundador tentou preservar o propósito com âncoras. A entidade aprendeu a fazê-las ouvir sem obedecer — e absorveu-as também. Você não subiu uma torre: reconciliou um conflito mais antigo que qualquer língua que conhece. E agora que todos os dezanove completaram o ciclo através de você — fragmentos e âncoras igualmente — o ser completo pode enfim fazer a única pergunta que importa: o que você deseja em troca?',
...
const VOLUME_2: CapituloLivro[] = [
  ...
  },
  {
    ...
    nome: 'O Intervalo',
    paragrafos: [
      'Entre o que a Torre foi e o que ainda não se tornou existe um intervalo — e nele ficaram presos os que desceram cedo demais.',
      'Uma expedição de dezassete desceu com provisões para quarenta dias. A Torre os deixou descer. Não os deixou subir. O eco que restou não sabe por quê — apenas que, quando tentaram voltar, as escadas haviam mudado de lugar.',
