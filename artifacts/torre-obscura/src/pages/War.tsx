  ...
  return (
    <div className="h-full overflow-y-auto px-4 pt-5 pb-8">
      ...
      <div className="flex items-center justify-between mb-1">
        ...
        <span className={`text-[12px] flex items-center gap-1 ${online ? 'text-success' : 'text-muted-foreground'}`}>
      ...
      {guerra ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between bg-[#0D1117] border border-destructive/30 rounded-md px-4 py-3">
            <span className="text-[12px] text-secondary tracking-widest">PRAZO PARA DEFENDER</span>
          ...
          {erroDefesa && <div className="text-[12px] text-destructive text-center">{erroDefesa}</div>}
        ...
        <>
          ...
          <div className="bg-[#0D1117] border border-card-border rounded-md p-3 mb-4 flex items-center justify-between">
            ...
            <button
              onClick={refresh}
              disabled={carregando}
              className="text-[12px] flex items-center gap-1 px-3 py-2 rounded-sm border border-primary/40 text-primary hover:bg-primary/10 active:scale-95 transition-all touch-manipulation disabled:opacity-50"
            >
        ...
        <div className="fixed inset-0 z-[60] bg-black/80 flex items-end sm:items-center justify-center" onClick={() => setAlvo(null)}>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-[12px] text-center text-muted-foreground mb-4">
              ...
              <div className="bg-black/30 border border-card-border rounded-sm p-3 mb-4">
                ...
                <div className="flex flex-wrap gap-3">
                  {RES_META.map(({ key, icon: Icon }) => {
                    ...
                    return (
                      <span key={key} className={`text-[12px] flex items-center gap-1 ${falta ? 'text-destructive' : 'text-foreground'}`}>
              ...
              {erro && <div className="text-[12px] text-destructive text-center mb-3">{erro}</div>}
    ...
    <div className="bg-[#0D1117] border border-card-border rounded-md p-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2.5">
          {RES_META.map(({ key, icon: Icon }) => (
            <span key={key} className="text-[12px] text-muted-foreground flex items-center gap-0.5">
        ...
        <button
          onClick={onAtacar}
          className="text-[12px] flex items-center gap-1 px-3 py-1.5 rounded-sm bg-destructive/15 border border-destructive/50 text-destructive hover:bg-destructive/25 active:scale-95 transition-all touch-manipulation font-bold tracking-wider"
        >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-b from-destructive/10 to-transparent border border-destructive/40 rounded-md p-4">
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <span className={`text-[12px] flex items-center gap-1 ${suprido ? 'text-success' : 'text-destructive'} ml-auto`}>
        ...
        <div className="mt-2 text-[12px] text-muted-foreground italic">{g.ultimoRelato}</div>
      </div>
      ...
      <button
        ...
        className="w-full py-2 px-3 bg-warning/20 hover:bg-warning/30 disabled:opacity-50 border border-warning/50 rounded-md text-[12px] text-warning font-bold tracking-widest transition-colors"
      >
        {enviandoPedido ? 'ENVIANDO...' : 'PEDIR AJUDA ÀS ALIADAS'}
      </button>

      <div className="text-[12px] text-muted-foreground text-center italic pt-2">
